 ...
 * The Class CtrlTuite.
 */
public class CtrlTuite extends UnicastRemoteObject implements RemoteNotify {
	...
	public TuiteTO doTuite(TuiteTO t){
		if (t != null)
    	{
			try {
				...
				remoteService.sendMessage(main.getUser(), EnumRemoteObject.TUITE, main.getUser().getLoginName());
			} catch (RemoteException e){
