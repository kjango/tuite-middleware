...
public class Util {
	...
	public static String FACTORYDEFAULT = "TopicCF";
	public static String TOPICLOGIN = "topicLogin";
	public static String TOPICFOLLOW = "topicFollow";
	public static String TOPICTUITE = "topicTuite";
